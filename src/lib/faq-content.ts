...
export const proPricingData: FaqItem[] = [
  ...
  },
  {
    ...
    a: 'Reports, photos and signatures are stored encrypted on our infrastructure, with access controls and TLS in transit. Photos sent for AI analysis are processed under our AI provider\'s commercial terms and are never used to train AI models. Your data is never sold, and it is only shared with the service providers needed to run Snagify — listed transparently in our Privacy Policy.',
  },
  {
