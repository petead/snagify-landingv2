...
pubDate: 2026-09-02
author: "Pierre Adam"
tags: ["check-in", "rdc", "evidence"]
faq:
  - question: "What is a check-in report in Dubai?"
    answer: "A dated, room-by-room record of a rental property's condition at the start of the tenancy: photos of every room and appliance, meter readings, an inventory of keys and furnishings, tied to the tenancy contract and signed by both landlord and tenant. It establishes the baseline against which every future damage claim is measured."
  - question: "Is there an official check-in report form in Dubai?"
    answer: "No. Neither the RDC, RERA nor the Dubai Land Department publishes a mandatory template, and no law prescribes a format. Validity comes from evidentiary quality, clear identification of property and parties, dates, photographic coverage and signatures, not from any official form, because none exists."
  - question: "Is a digital check-in report valid at the RDC?"
    answer: "Yes. Dubai courts accept digitally signed documents with verifiable timestamps, and a tamper-evident digital report with a cryptographic hash is straightforward to authenticate. What the RDC weighs is whether the evidence is dated, attributable and unaltered, not whether it was made on paper."
  - question: "Who is supposed to prepare the check-in report, landlord or tenant?"
    answer: "Nobody is legally obligated, which is exactly the problem: either party can prepare it, and both benefit. The landlord gains the baseline that makes deductions enforceable, the tenant gains protection against inherited damage. Whoever cares more about the deposit should make sure it exists."
