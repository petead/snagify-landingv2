---
title: "Normal Wear and Tear vs Damage: Where Dubai Law Draws the Line"
description: "Faded paint, scratched floors, limescale, AC filters: what counts as normal wear and tear in a Dubai rental, what counts as damage, and the three questions that decide every dispute."
pubDate: 2026-07-31
author: "Pierre Adam"
tags: ["wear-and-tear", "deposits", "tenant-rights"]
faq:
  - question: "What is considered normal wear and tear in a Dubai rental?"
    answer: "The inevitable, gradual deterioration of a property under careful, ordinary use: faded paint, minor wall scuffs, small nail holes, traffic patterns on flooring, sun-faded curtains, limescale from Dubai's hard water, and worn grout. None of these are deductible from a deposit, because they are the cost of the property being lived in, which the rent already pays for."
  - question: "What counts as damage a landlord can charge for in Dubai?"
    answer: "Harm beyond ordinary use: holes in doors, burns or deep gouges in countertops and floors, broken fixtures, cracked tiles from impact, stains that will not clean, unauthorized paint colors, and pet damage. The landlord must prove both the damage and the property's better condition at move-in, typically through a signed check-in report."
  - question: "Is faded paint normal wear and tear in Dubai?"
    answer: "Yes. Paint fading, especially under Dubai's sun exposure, is textbook normal wear, and the RDC's guidance treats routine repainting between tenancies as the owner's maintenance responsibility. A landlord cannot charge a departing tenant for a standard repaint."
  - question: "Who pays for AC maintenance in a Dubai rental?"
    answer: "It follows the contract's maintenance clause: minor servicing below a threshold (commonly AED 500) is often the tenant's, while major repairs and unit replacement are the landlord's. Dirty filters after a year of use are wear; a unit broken because servicing was never done despite a contractual duty can become the tenant's problem, which is why keeping service receipts matters."
  - question: "How does the RDC decide wear and tear disputes?"
    answer: "On evidence of the property's condition at both ends of the tenancy. The claiming party, almost always the landlord, must prove the deterioration exceeds normal use and post-dates move-in. Without a signed check-in baseline, that proof rarely exists, and the claim fails regardless of how the deterioration is labeled."
draft: false
category: blog
featured: false
readingMinutes: 6
