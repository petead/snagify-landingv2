---
title: "Is a Check-in Report Mandatory in Dubai? (What Expats Get Wrong)"
...
faq:
  - question: "Is a check-in report required by law in Dubai?"
    answer: "No. Dubai Law No. 26 of 2007 regulates deposits and deductions but does not require any condition report at move-in. No authority will provide one, and no landlord is obligated to arrange one. If you want a documented baseline, you have to create it yourself."
  - question: "Does my Dubai landlord have to provide a check-in inspection?"
    answer: "No. Some professional property managers do one as good practice, but there is no legal obligation. Most tenancies in Dubai start with no condition documentation at all, which is why deposit disputes so often come down to one person's word against another's."
  - question: "Can I make my own check-in report without the landlord?"
    answer: "Yes, and you should if the landlord will not participate. A structured, time-stamped, room-by-room record created on day one and emailed to the landlord is dramatically stronger evidence than nothing. A version signed by both parties is stronger still, so always offer the landlord the chance to sign."
  - question: "Is a check-in report valid if the landlord refuses to sign it?"
    answer: "It still has real evidentiary value. Email the report to the landlord and agent on move-in day so there is a dated record that they received it and raised no objection. A documented refusal to sign, noted in the report, tends to work against the refusing party, not against you."
...
Read those two paragraphs together and the structure of the problem appears. The law gives you strong substantive rights, and provides zero infrastructure for the evidence those rights depend on. The [Rental Disputes Center](https://rdc.gov.ae/en/) decides deposit cases on proof of condition, and the system leaves the production of that proof entirely to you.
...
[Document every room before your furniture arrives](/blog/move-in-inspection-checklist-dubai). Walls, floors, ceilings, appliances, fixtures, meters. An empty apartment is the cleanest baseline you will ever have.

Make it structured and time-stamped. A camera roll of loose photos is better than nothing, but a room-by-room condition record with dates tied to your tenancy reads very differently in a dispute. This is the [difference between photos and evidence](/blog/rdc-evidence-photos-vs-signed-reports).
