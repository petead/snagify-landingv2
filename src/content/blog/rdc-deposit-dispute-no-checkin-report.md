---
title: "What Happens at the RDC When There's No Check-in Report (A Real Case)"
...
faq:
  - question: "Who has to prove damage in a Dubai deposit dispute?"
    answer: "The party making the claim, which is almost always the landlord withholding the deposit. To justify a deduction, the landlord must prove both that the damage exists and that the property was in better condition at move-in. Without a signed check-in report, that second part is nearly impossible to establish."
  - question: "Can a landlord in Dubai charge the tenant for repainting?"
    answer: "Generally no. Repainting between tenancies is treated as the owner's maintenance responsibility, and normal wear on walls is not damage. A landlord can only claim for genuine damage beyond normal wear and tear, and must prove the original condition to do so."
  - question: "How long does an RDC deposit case take?"
    answer: "In my case, about four months from filing to having the money back. The RDC resolves some cases faster, but contested disputes with hearings take time, which is worth knowing before assuming you will just claim the deposit later."
  - question: "Are RDC hearings in person?"
    answer: "Mine was held remotely over Microsoft Teams. You join a virtual queue, wait for your case to be called, and present to the judge by video. Several cases are heard in the same session."
