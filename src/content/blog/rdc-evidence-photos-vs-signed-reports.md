...
faq:
  - question: "What evidence does the RDC accept in a rental dispute?"
    answer: "The RDC accepts tenancy contracts and Ejari certificates, payment proofs, utility bills, written correspondence, photos and videos, and condition or inspection reports. Filings are electronic, documents must be in Arabic or legally translated, and evidence must be submitted before the judgment session, not during it."
  - question: "Are WhatsApp photos valid evidence in a Dubai deposit dispute?"
    answer: "They can be submitted, but they are weak. WhatsApp compresses images and strips the metadata that proves when a photo was taken, and loose photos carry no signatures, no link to the tenancy, and no acknowledgment from the other party. They prove a wall existed, not when it looked that way or who agreed."
  - question: "Do photos need timestamps to count at the RDC?"
    answer: "Dating is what gives a photo evidentiary weight. A dispute is always about condition at a specific moment, move-in or move-out, so an undatable image proves very little. Structured reports that tie each photo to a date and a tenancy solve exactly this problem."
  - question: "Is an unsigned inspection report valid at the RDC?"
    answer: "It has value, especially if it was emailed to the other party at the time and never objected to, but a report signed by both parties is in a different category: it is not one side's version of events, it is a fact both sides agreed on. A documented refusal to sign typically counts against the refusing party."
...
**Level two: structured, dated documentation.** The same photos, organized room by room, each tied to a date and to the tenancy, assembled into a single document and emailed to the other party at the time. This is a real evidentiary step up: it can be translated as one document, read as one narrative, and the delivery email gives it a timestamp the other side received and never objected to. If you are documenting alone because your landlord will not participate, this is your target.

**Level three: the signed condition report.** Room-by-room, photo-mapped, time-stamped, and signed by both parties at the handover. This is a different species of evidence from everything below it, for one reason: it is no longer your version of events. It is a fact the landlord and tenant agreed on, in writing, before any dispute existed. A judge does not have to weigh credibility or reconstruct timelines. The baseline is simply established, and every claim gets measured against it.

The distance between level one and level three is the distance between an argument and a verdict. It is also about twenty minutes of work at the right moment.

## The part landlords and agencies get wrong

Tenants lose time in this system. Landlords lose money, and the asymmetry is brutal.
...
At move-in, document every room before the furniture arrives, get the record structured and time-stamped, and get both signatures at the handover. If the other party will not sign, email them the full report the same day and note the refusal: a delivered, unobjected-to report is strong, and a documented refusal tends to work against the refuser.
